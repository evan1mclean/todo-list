...
class UI {
    ...
    static taskTemplate(title, dueDate, completed) {
        ...
        if (completed) {
            newItem.innerHTML = `<input type="checkbox" class="completed" checked>
                ...
                <p class="due-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dueDate), 'P')}</p>
    ...
    static displayTodoDetails(e) {
        ...
        const item = _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].getTodoList().getProject(project).getItemFromProject(title);
        ...
        container.innerHTML = `<div class="item-header">
            ...
            <div class="information">
                <p>${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(item.dueDate), 'P')}</p>
                <p>${item.priority}</p>
                <p>${completed}</p>
            </div>`;
    ...
    static toggleCompletedTasks(e) {
        ...
        _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].storeTodoList(todoList);
    ...
    static deleteTask(e) {
        const currentProject = document.querySelector('.todo-header').textContent;
        const title = e.target.parentElement.textContent.trim().split("\n")[0];
        const currentProjectItem = _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].getTodoList().getProject(currentProject).getItemFromProject(title);
        const item = _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].getTodoList().getProject(currentProjectItem.project).getItemFromProject(title);
        _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].deleteItemFromProject(item.project, item);
        UI.clearTasks();
        UI.displayTasks();
        UI.eventListeners();
    }
    ...
    static displayTaskEditForm(e) {
        ...
        const item = _Storage__WEBPACK_IMPORTED_MODULE_1__["default"].getTodoList().getProject(todoHeader).getItemFromProject(itemTitle);
        const modal = document.querySelector('.modal');
        const modalContent = document.querySelector('.modal-content')
        modal.classList.add('show-modal');
        modalContent.classList.add('show-modal');
