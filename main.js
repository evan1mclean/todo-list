    ...
    static taskTemplate(title, dueDate, completed) {
        ...
        if (completed) {
            newItem.innerHTML = `<input type="checkbox" class="completed" checked>
                ...
                <p>${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dueDate), 'P')}</p>
